    ...
    <div className="p-6">
      ...
      {docs.length === 0 ? (
        <div className="py-12 text-center text-[#8C7A6B]">
          No Origins of Coffee found.
        </div>
      ) : (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
          {docs.map((item) => {
            const editUrl = `${adminRoute}/collections/countries/${item.id}`;
            ...
            return (
              ...
              >
                ...
                <div className="mt-6 flex justify-between w-full border-t border-white/10 pt-4">
                  <p className="text-lg font-bold text-white transition-colors group-hover:text-[#D8A46B]">
                    Review Count:
                  </p>
