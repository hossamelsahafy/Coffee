...
const Faqs = ({ data, locale }) => {
  ...
  return (
    <section
      className="py-16 px-4 max-w-4xl mx-auto text-base-CopffeeLight"
      dir={isArabic ? "rtl" : "ltr"}
    >
      <h2 className="text-3xl md:text-4xl font-bold mb-10 text-center tracking-wide text-base-CopffeeLight">
